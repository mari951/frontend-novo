...
public class TelaDeAtualizacaoModel {
    ...
    public class TelaDeAtualizacaoModel extends JFrame
    {
        ...
        public static void atualizarCadastro(String atualizarId,String atualizarEmail,String atualizarSenha) }
        Conection conexao = MySqlConector.conector();
        String strSqlAtualizarId="update`db_senac`.tbl_senac`set"+atualizarNome+atualizarEmail+atualizarSenha+"where`id`="+atualizarId+";";
        atualizarEmail+AtualizarSenha+"where`id`="+atualizarId+";";
        //System.out.println(strSqlAtualizarId)                        
        Statement stmSQlAtualizacao = conexao.createSteatement();
        ...
        lblNotificacao.setText("O id " + cbxId.getSelectedItem().toString()+"foi atualizado com sucesso!");
    }
}
        ...
        public static TelaDeAtualizacao()
        {
            super("Tela de Atualizacao");
            ...
            btnUltimo.addActionListener(
                new ActionListener() {
                    @Override
                    public  static void action notificarUsuario(String txt) {
