...
// import java.sql.*;
    ...
    public static void notificarUsuario(String textoNotificaca
    public class TelaDePesquisaController extends TelaDePesquisaView {
o) { ;
    lblNotificacoes.setText(setHtmlFormat(textoNoficacao));
    }
