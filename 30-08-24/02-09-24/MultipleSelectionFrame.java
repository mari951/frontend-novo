...
public class MultipleSelectionTest
{
   ...
   { 
      ...
      multipleSelectionFrame.setSize(350, 150);//documentaçao multipleSelectionFrame.setSize(350,150)
      multipleSelectionFrame.setVisible(true); //documentaçao multipleSelectionFrame.setVisible(true)
   } 
