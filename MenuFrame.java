// Fig. 19.5: MenuFrame.java // documentacao de menu frame 
// Demonstrating menus.
import java.awt.Color; // linha de java color 
...
{
   private final Color[] colorValues =  // linha de private color values 
